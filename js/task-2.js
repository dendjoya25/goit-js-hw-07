...
const createGalleryCard = imagesInfo => {
...
const galleryCardsArray = images.map(cardInfo => createGalleryCard(cardInfo));

const galleryListEl = document.querySelector('.gallery');
galleryListEl.classList.add('js-gallery');

galleryListEl.append(...galleryCardsArray);
